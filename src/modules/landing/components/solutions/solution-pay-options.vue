<template>
  <div class="solution-pay-options yellow-100-bg">
    <div class="vesicash-container">
      <div class="row">
        <!-- IMAGE SECTION -->
        <div class="img-section col-12 col-md-6">
          <div class="position-relative w-100">
            <img
              v-lazy="loadImage('payment-options.png', 'landing')"
              alt="Vesicash-payment-options"
              class="wt-100"
            />
          </div>
        </div>
